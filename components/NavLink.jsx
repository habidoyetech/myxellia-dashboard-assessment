...
const NavLink = ({linkName, boxBorderRadius, textfontWeight, boxBg = 'transparent', linkLogo, linkLogoAlt}) => {
  return (
    <Box py={2} px={5} cursor='pointer' bgColor={boxBg} borderRadius={boxBorderRadius} >
