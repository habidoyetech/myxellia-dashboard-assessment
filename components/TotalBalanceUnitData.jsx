...
const TotalBalanceUnitData = ({width, balanceUnitImageBorderColor, balanceUnitImagePadding, height, headingFontsize = '20px', statNumberColor, children, statHelpText, statNumberFontSize, more}) => {
  return (
    <Box>
        <HStack gap={4} alignItems='start'>
            ...
            <VStack flex={1} alignItems='flex-start' gap={4} justifyContent='start' >
                ...
                {statNumberColor && <StatComponent statNumberColor={statNumberColor} statHelpText={statHelpText} statNumberFontSize={statNumberFontSize} >{children}</StatComponent>}
                <Box>    
                    {more &&
